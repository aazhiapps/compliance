 ...
 */
router.post("/trigger-itc-sync", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.post("/trigger-cleanup", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.post("/trigger-report", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.get("/queue-stats/:queueName", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.get("/:jobId/status", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.get("/logs/summary", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
 ...
 * Requires: Authentication + Admin
 */
router.post("/:jobId/retry", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
    const { jobId } = req.params;
 ...
 * Requires: Authentication + Admin
 */
router.delete("/:jobId/cancel", authenticateToken, requireAdmin, async (req: Request, res: Response) => {
  try {
    const { jobId } = req.params;
    const { queueName = "jobs" } = req.body;
